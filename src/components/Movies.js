...
export default class Movies extends Component {
    ...
    async componentDidMount(){
        //Side effects 
        const res = await axios.get(`https://api.themoviedb.org/3/movie/popular?api_key=8b6210bdbcb2de90aa163b9&language=en-US&page=${this.state.currPage}`);
        let data = res.data
        // console.log(data);
        this.setState({
            movies:[...data.results]
    ...
    changeMovies=async()=>{
        ...
        const res = await axios.get(`https://api.themoviedb.org/3/movie/popular?api_key=8b6210bdbcb2de99&language=en-US&page=${this.state.currPage}`);
        let data = res.data
        // console.log(data);
        this.setState({
            movies:[...data.results]
